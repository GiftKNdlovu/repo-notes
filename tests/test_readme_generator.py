...
def test_readme_snapshot_matches():
    ...
    expected = (
        ...
        "A test project\n"
        "\n"
        "> This file was generated by `repo-notes`. "
        ...
        "## Features\n"
        "\n"
        "- **test-project** project scanned for structure, dependencies, security, complexity, and more\n"
        "- **3 runtime dependencies** — click, pyyaml, rich\n"
        "- **Test suite** — detected test files\n"
        "\n"
        "## Usage\n"
        "\n"
        "```\n"
        ...
        "```\n"
        "\n"
        "Scan a repository and generate project notes. "
